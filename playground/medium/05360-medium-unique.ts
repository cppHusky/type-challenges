...
type Include<T extends unknown[],U extends unknown>=
	T extends [...infer R,infer A]?
	...
	:
		false
type Unique<T extends unknown[],Prefix extends unknown[]=[]>=
	T extends [infer A,...infer R]?
		Include<Prefix,A> extends true?
			Unique<R,Prefix>
		:
			Unique<R,[...Prefix,A]>
	:
