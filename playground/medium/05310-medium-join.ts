...
type Join<T extends string[],U extends string|number=',',Prefix extends string=''>=
	T extends [infer A extends string,infer B extends string,...infer R extends string[]]?
		Join<[B,...R],U,`${Prefix}${A}${U}`>
